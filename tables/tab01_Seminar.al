...

{
    ...
    var
        SeminarRec: Record "CSD Seminar";
        SeminarSetupRec: Record "CSD Seminar Setup";
    begin
        SeminarRec := Rec;
        SeminarSetupRec.get;
        SeminarSetupRec.TestField("Seminar Nos.");
        if NoSeriesMgt.SelectSeries(SeminarSetupRec."Seminar Nos.", xRec."No. Series", "No. Series") then begin
